...
!======================================================================================================!
open (unit=3,file="parametros_N16384_v1_S100_d2_c0p06.txt",action="write",status="replace")
open (unit=8,file="contagens_N16384_v1_S100_d2_c0p06.csv",action="write",status="replace")
open (unit=10,file="informacoes_N16384_v1_S100_d2_c0p06.txt",action="write",status="replace")
!======================================================================================================!  
