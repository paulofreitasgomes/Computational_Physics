...
folder2 = folder +'dinamica10_Sandro/res47/res47ah/'

dados1 = pd.read_csv(folder2+'dados_47a.txt', header = None, sep = '|')
dados1.columns = dados_names

dados2 = pd.read_csv(folder2+'dados_47b.txt', header = None, sep = '|')
dados2.columns = dados_names

dados3 = pd.read_csv(folder2+'dados_47c.txt', header = None, sep = '|')
dados3.columns = dados_names

dados4 = pd.read_csv(folder2+'dados_47d.txt', header = None, sep = '|')
dados4.columns = dados_names

dados5 = pd.read_csv(folder2+'dados_47e.txt', header = None, sep = '|')
dados5.columns = dados_names

dados6 = pd.read_csv(folder2+'dados_47f.txt', header = None, sep = '|')
dados6.columns = dados_names

dados7 = pd.read_csv(folder2+'dados_47g.txt', header = None, sep = '|')
dados7.columns = dados_names

dados8 = pd.read_csv(folder2+'dados_47h.txt', header = None, sep = '|')
dados8.columns = dados_names

folder4 = folder +'dinamica10_Sandro/res45/res45aj/'

dados9 = pd.read_csv(folder4+'dados_45h.txt', header = None, sep = '|')
dados9.columns = dados_names

folder3 = folder +'dinamica10_Sandro/res45/res45kr/'

dados10 = pd.read_csv(folder3+'dados_45r.txt', header = None, sep = '|')
...
plt.title(r'Quenched: $K = 4$, $v_0 = 5$.',fontsize=14)
plt.grid(True)
plt.xticks(size=14)
plt.yticks(size=14)
axes = plt.gca()
...
#plt.text(2.5,1.8,r'$v_0 =5$',fontsize = 16, color = 'k', backgroundcolor = 'w')
plt.savefig('figura_8a.pdf',dpi = 300, bbox_inches='tight') 
plt.close()
...
#plt.text(5,1.5,r'$v_0 =5$',fontsize = 12, color = 'b', backgroundcolor = 'w')
plt.savefig('figura_8b.pdf',dpi = 300, bbox_inches='tight') 
plt.close()
