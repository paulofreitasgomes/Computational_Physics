...
folder2 = folder +'dinamica10_principal/res46/C_vs_delta/res46ip/'
...
folder3 = folder +'dinamica10_principal/res58/res58gl/'
...
plt.plot(lista1e9x,lista1e9y,'or', ms = 8, label = r'quenched: $v_0 = 0.0$')
#plt.semilogy(lista2e11x,lista2e11y,'^g', ms = 4, label = r'$v_0 = 0.5$')
plt.plot(lista8e14x,lista8e14y,'sb', ms = 4, label = r'quenched: $v_0 = 5.0$')
plt.plot(dados15.delta,dados15.nviz,'-k', lw = 2, label = r'annealed',
...
plt.title(r'Relevo $K = 4$, $M = 53$.',fontsize = 14)
plt.grid(True)
plt.xticks(size=14)
plt.yticks(size=14)
axes = plt.gca()
axes.set_xlim([1.8,2.2])
axes.set_ylim([10,15])
#plt.text(1.1,3.1,r'$M=53$',fontsize = 14)#, color = 'b', backgroundcolor = 'w')
plt.savefig('figura_16.pdf',dpi = 300, bbox_inches='tight') 
plt.close()
