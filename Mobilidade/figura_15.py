...
folder2 = folder +'dinamica11_random/res62ah/'

dados1 = pd.read_csv(folder2+'dados_62a.txt', header = None, sep = '|')
dados1.columns = dados_names

dados2 = pd.read_csv(folder2+'dados_62b.txt', header = None, sep = '|')
dados2.columns = dados_names

dados3 = pd.read_csv(folder2+'dados_62c.txt', header = None, sep = '|')
dados3.columns = dados_names

dados4 = pd.read_csv(folder2+'dados_62d.txt', header = None, sep = '|')
dados4.columns = dados_names

dados5 = pd.read_csv(folder2+'dados_62e.txt', header = None, sep = '|')
dados5.columns = dados_names

dados6 = pd.read_csv(folder2+'dados_62f.txt', header = None, sep = '|')
dados6.columns = dados_names

dados7 = pd.read_csv(folder2+'dados_62g.txt', header = None, sep = '|')
dados7.columns = dados_names

dados8 = pd.read_csv(folder2+'dados_62h.txt', header = None, sep = '|')
...
plt.loglog(dados3.Nv,dados3.custo,'pk', ms = 5, label = r'$\delta = 0.75 $')
plt.loglog(dados4.Nv,dados4.custo,'dc', ms = 5, label = r'$\delta = 1.0 $')
plt.loglog(dados5.Nv,dados5.custo,'vm', ms = 5, label = r'$\delta = 2.0 $')
#plt.loglog(dados6.Nv,dados6.custo,'pm', ms = 4, label = r'$\delta = 3.0 $')
...
plt.title(r'Caso \textit{annealed}: relevo $K = 0$.',fontsize=14)
plt.grid(True)
plt.xticks(size=14)
plt.yticks(size=14)
axes = plt.gca()
...
plt.savefig('figura_15a.pdf',dpi = 300, bbox_inches='tight') 
plt.close()


plt.loglog(dados1.Nv,dados1.Nv-1,'-k', ms = 5, label = r'$N_v-1$')
plt.loglog(dados1.Nv,dados1.nviz,'vg', ms = 5, label = r'$\delta = 0.25 $')
plt.loglog(dados2.Nv,dados2.nviz,'sb', ms = 5, label = r'$\delta = 0.5 $')
plt.loglog(dados3.Nv,dados3.nviz,'pk', ms = 5, label = r'$\delta = 0.75 $')
plt.loglog(dados4.Nv,dados4.nviz,'dc', ms = 5, label = r'$\delta = 1.0 $')
plt.loglog(dados5.Nv,dados5.nviz,'vg', ms = 5, label = r'$\delta = 2.0 $')
plt.loglog(dados6.Nv,dados6.nviz,'pm', ms = 4, label = r'$\delta = 3.0 $')
...
plt.savefig('figura_15b.pdf',dpi = 300, bbox_inches='tight') 
plt.close()
